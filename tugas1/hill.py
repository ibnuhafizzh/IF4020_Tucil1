...
plaintext = ""
key = "6 24 1\n13 16 10\n20 17 15"

ciphertext = hill_cipher(plaintext, key, "encrypt")
print("Encrypted message:", plaintext)
print("\n")
decrypted_message = hill_cipher(plaintext, key, "decrypt")
